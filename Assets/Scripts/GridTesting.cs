...
public class GridTesting : MonoBehaviour
{
    ...
    */
    ...
    private Vector3 GetPointerWorldPosition()
    {
        ...
        {
            VRRay = Camera.main.ScreenPointToRay(hitPosition);
        }

        //Debug.Log(playerInput.currentControlScheme.ToLower());
        if (Physics.Raycast(mouseRay, out RaycastHit mouseHit, 999f, mouseColliderLayerMask))
        {
            return mouseHit.point;
        }
        else if(Physics.Raycast(VRRay, out RaycastHit raycastHit, 999f, mouseColliderLayerMask))
        {
